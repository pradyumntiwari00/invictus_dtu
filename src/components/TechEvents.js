...
const openAirCompetitions = [
    ...
    {img: require('../images/logo.png'),idx: 6, name: "Hydrojet", location: "", DDT: "13-15th February 2023", about: "Make a structurally stable hydrojet launcher which launches a bottle to a certain height and distance.", regLink: "https://unstop.com/p/invictus-23-delhi-technological-university-dtu-new-delhi-593480"},
]

const quizzes = [
    {img: require('../images/logo.png'),idx: 1, name: "The LabRats Quiz", location: "TBA", DDT: "13-15th February 2023", about: "A technical quiz competition haaving spanning topics from research to practical application in the field of biotechnology and natural sciences.", regLink: "https://unstop.com/p/lab-rats-quiz-on-health-and-nutrition-invictus-23-delhi-technological-university-dtu-new-delhi-593815"},
    ...
    {img: require('../images/logo.png'),idx: 4, name: "Tech Challenge", location: "", DDT: "13-15th February 2023", about: "NeuralAI,DTU brings an amazing challenge of applying your technical knowledge and skills to solve challenges of real-world problems.", regLink: ""},
...
const Hackthon_Ideathon = [
    ...
    {img: require('../images/logo.png'),idx: 3, name: "Brainwave", location: "", DDT: "13-15th February 2023", about: "An Arduino based design Challenge where problem Statements would be released online and you will be assigned topics", regLink: "https://unstop.com/p/brainwave-invictus-23-delhi-technological-university-dtu-new-delhi-596762"},
    {img: require('../images/logo.png'),idx: 4, name: "Envision", location: "", DDT: "13-15th February 2023", about: "A system design hackathon where teams will be given a system design problem and they will have to come up with an efficient and scalable real-life solution", regLink: "https://unstop.com/p/envision-invictus-23-delhi-technological-university-dtu-new-delhi-590459"},
    {img: require('../images/logo.png'),idx: 5, name: "Research Hackathon", location: "", DDT: "13-15th February 2023", about: "Solve a problem based on the field you pick and will present their work in front of a panel of eminent professors of department of physics.", regLink: "https://unstop.com/p/research-hackathon-astronomy-invictus-23-delhi-technological-university-dtu-new-delhi-593149"},
]
...
const ai_summit = [
    ...
    {img: require('../images/logo.png'),idx: 2, name: "Statistica", location: "TBA", DDT: "13-15th February 2023", about: "You will be thrown a number of questions related to Statistics.You can choose a level depending upon your proficiency.", regLink:""},
    {img: require('../images/logo.png'),idx: 3, name: "Techno Vision", location: "TBA", DDT: "13-14th February 2023", about: "A research showcase competition to present some research in any fields ,result will be based on the impact factor in the real world.",regLink:"https://unstop.com/p/techno-vision-invictus-23-delhi-technological-university-dtu-new-delhi-590462"},
...
const symposium = [
    ...
    {img: require('../images/logo.png'),idx: 2, name: "Panel Discussion", location: "TBA", DDT: "13-15th February 2023", about: "A panel discussion with industry experts from across India (IAS, IPS, and/or IFS) on different topics. The discussion will include the role of technology and environmental sustainability.",regLink: "https://unstop.com/p/panel-discussion-by-industry-experts-invictus-23-delhi-technological-university-dtu-new-delhi-593195"},
